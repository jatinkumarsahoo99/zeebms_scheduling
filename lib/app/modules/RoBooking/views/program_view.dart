                ...
                child: Container(
                  ...
                  child: Wrap(
                    ...
                    children: [
                      ...
                      DropDownField.formDropDown1WidthMap([DropDownValue(key: (1).toString(), value: (1).toString())], (value) => {}, "Seg", 0.40,
                          selected: controller.selectedSeg, dialogWidth: Get.width * 0.12, dialogHeight: Get.height * 0.20),
                      InputFields.formField1(
                          // showTitle: false,
                          hintTxt: "Duration",
                          isEnable: false,
                      ...
                      FormButtonWrapper(
                        ...
                        callback: () {
                          controller.getSegment(controller.programViewGrid?.currentRowIdx);
                        },
                      ),
                      InputFields.formField1(
                          // showTitle: false,
                      ...
                      FormButtonWrapper(
                        ...
                        callback: () {
                          if (controller.selectedTapeID?.key == null || controller.selectedTapeID?.value == null) {
                            LoadingDialog.callInfoMessage("Please select the tape id first and then add spot.");
                          } else {
                            controller.addSpot();
                          }
                        },
