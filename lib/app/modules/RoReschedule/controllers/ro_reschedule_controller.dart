...
class RoRescheduleController extends GetxController {
  ...
  dgvGridnRowDoubleTap(index) {
    if (roRescheduleOnLeaveData!.lstDgvRO![index].colorName?.toLowerCase().toString() == "grey") {
    } else {
        ...
        Get.find<ConnectorControl>().POSTMETHOD(
            ...
            fun: (data) {
              ...
              if (data is Map<String, dynamic> && data.containsKey("info_OnClickdgvViewRo")) {
                ...
                if ((viewDoubleClickData.message) != null && (viewDoubleClickData.message ?? []).isNotEmpty) {
                              ...
                              children: [
                                ...
                                DateWithThreeTextField(
                                    ...
                                    mainTextController: TextEditingController(
                                        text:
                                            DateFormat("dd-MM-yyyy").format(DateFormat("MM/dd/yyyy HH:mm:ss").parse(viewDoubleClickData.schDate!)))),
                                InputFields.formField1(
                                    isEnable: false,
                                    hintTxt: "Time",
                                ...
                                DateWithThreeTextField(
                                    ...
                                    mainTextController: TextEditingController(
                                        text:
                                            DateFormat("dd-MM-yyyy").format(DateFormat("MM/dd/yyyy HH:mm:ss").parse(viewDoubleClickData.killDate!)))),
                                InputFields.formField1(
                                    isEnable: false,
                                    hintTxt: "Cmp Prod",
                                    controller: TextEditingController(
                                        text: DateFormat("dd-MM-yyyy")
                                            .format(DateFormat("MM/dd/yyyy HH:mm:ss").parse(viewDoubleClickData.campStartDate!))),
                                    width: 0.115),
                                InputFields.formField1(
                                    isEnable: false,
                                    hintTxt: "",
                                    controller: TextEditingController(
                                        text: DateFormat("dd-MM-yyyy")
                                            .format(DateFormat("MM/dd/yyyy HH:mm:ss").parse(viewDoubleClickData.campEndDate!))),
                                    width: 0.115),
                                FormButtonWrapper(
                                  btnText: "Add Spots",
                                  callback: () {
                          ...
                          Expanded(
                            ...
                            child: DataGridWithShowOnlyKeys(
                              ...
                              onRowDoubleTap: (rowdblclick) {
                                ...
                                addSpotGridManager!
                                    .changeCellValue(rowdblclick.row.cells["bookedSpots"]!, "1", callOnChangedEvent: false, force: true);
                              },
