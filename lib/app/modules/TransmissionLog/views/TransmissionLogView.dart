                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          style: ButtonStyle(
                              ...
                              alignment: Alignment.center),
                          onPressed: () {
                            controller.toReplaceInsert_.text =controller.gridStateManager?.currentRow?.cells["transmissionTime"]?.value ?? "";
                            controller.toReplaceIndexInsert_.text =controller.gridStateManager?.currentRowIdx.toString()??"";
                          },
                          // icon: showIcon ? Icon(iconData, size: 16) : Container(),
                          child: Text("",
                              style: TextStyle(
