...
class DataGridMenu {
  ...
  showGridCustomMenu(PlutoGridStateManager stateManager, TapDownDetails details, BuildContext context, {String? exportFileName,Function? onPressedClick,required PlutoColumnRendererContext plutoContext}) async {
    clearFilterList() {
      Get.find<MainController>().filters1[stateManager.hashCode.toString()] = RxList([]);
    }
