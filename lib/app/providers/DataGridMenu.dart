...
class DataGridMenu {
  showGridMenu(PlutoGridStateManager stateManager,
    ...
    customFilter(PlutoGridStateManager stateManager) {
      ...
      if (stateManager.currentCell != null) {
        _allValues = stateManager.rows.map((e) =>
            e.cells[stateManager.currentCell!.column.field]!.value.toString())
            .toSet()
            .toList();
      }
      Get.defaultDialog(
                            ...
                            Card(
                              ...
                              child: InkWell(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    _allValues[index],
                                    style: _selectedValues.contains(
                                        _allValues[index])
      ...
      items: [
        ...
        PopupMenuItem<DataGridMenuItem>(
          ...
          child: Obx(
              ...
              return ((Get
                  .find<MainController>()
                  .filters1[stateManager.hashCode.toString()] ?? []).isEmpty)
                ...
                itemBuilder: (BuildContext context) {
                  ...
                  return <PopupMenuEntry<RowFilter>>[
                    for (var i = 0; i < _filters.length; i++)
                      PopupMenuItem(
                        child: Text("[${_filters[i].field}] ${_filters[i]
                            .operator == 'equal' ? '=' : '<>'} ${_filters[i]
                            .value}"),
                        onTap: () {
                          _filters.removeAt(i);
          ...
          ...List.generate(
            extraList.length,
              ...
              return PopupMenuItem<DataGridMenuItem>(
                ...
                child: Text(
                    extraList[index].title, style: TextStyle(fontSize: 13)),
              );
            },
          ).toList(),
        }
    ...
    switch (selected) {
      case DataGridMenuItem.selectedfilter:
        if (stateManager.currentCell != null) {
          Get
              .find<MainController>()
              .filters1[stateManager.hashCode.toString()]!
              .add(RowFilter(field: stateManager.currentCell!.column.field,
              operator: "equal",
      ...
      case DataGridMenuItem.exportToXml:
        Get.find<ConnectorControl>().POSTMETHOD_FORMDATAWITHTYPE(
          ...
          fun: (value) {
            ExportData().exportFilefromString(value,
                          ...
                          FocusTraversalOrder(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                const SizedBox(width: 5),
                                InputFields.formField1(hintTxt: "For",
                                ...
                                ElevatedButton(
                                    onPressed: () {
                                      ...
                                      stateManager.currentCell == null
                                          ? true
                                          : element.cells[stateManager
                                          .currentCell!.column.field]!.value ==
                                          stateManager.currentCell!.value);
                                    },
                                    child: Text("FS")),
                                SizedBox(width: 15),
  ...
  showGridCustomMenu(PlutoGridStateManager stateManager, TapDownDetails details,
    ...
    var selected = await showMenu(context: context,
        position: RelativeRect.fromSize(
            details.globalPosition & Size(40, 40), Get.size),
        items: [
          const PopupMenuItem<DataGridMenuItem>(
    ...
    var selected = await showMenu(context: context,
        ...
        items: [
          ...
          const PopupMenuItem<DataGridMenuItem>(
            ...
            enabled: true,
            child: Text(
                'Remove & Mark as Error', style: TextStyle(fontSize: 13)),
          ),
          const PopupMenuItem<DataGridMenuItem>(
